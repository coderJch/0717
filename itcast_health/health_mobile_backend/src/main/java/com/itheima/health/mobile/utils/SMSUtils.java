...
public class SMSUtils {
    ...
    public static final String VALIDATE_CODE = "SMS_174585802";//发送短信验证码
    ...
    public static void sendShortMessage(String phoneNumbers,String param) throws ClientException {
        ...
        final String accessKeyId = "LTAI5tSDg6RpJS6QJUCBEiJX";// 你的accessKeyId,
        final String accessKeySecret = "HwtMjuLb9QaaRxt6zYtFYfSp0zQNGS";// 你的accessKeySecret，
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("传智健康项目jch手机号");
        // 必填:短信模板-可在短信控制台中找到
    ...
    public static void main(String args[]) throws Exception{
        ...
        SMSUtils.sendShortMessage("13152630125",validateCode);
    }
}
